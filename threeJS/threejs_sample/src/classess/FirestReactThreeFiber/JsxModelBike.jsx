...
export default function JsxModelBike(props) {
  ...
  const secondMeshFront = useRef();
  // npx gltfjsx bike.gltf -- To convert model to jsx
  ...
  useFrame((_, delta) => {
    ...
    mainMesh.current.position.x += delta * 1.5;
    console.log("in frame");
  });

  // useEffect(() => {
  //   firstRef.current.rotation.y = 1;
  //   // secindRef.current.rotation.x += 1 * 3;
